...
function checkmon(v) {
  ...
  let mon_dis = document.getElementById("mon_dis");
...
function checkday(e) {
  ...
  // par_date_div.style.border="2px solid green"
  ...
  let date_dis = document.getElementById("date_dis");
  date_dis.innerText = par_date[0] + "," + full_year + " " + par_date[1];

  let re2 = document.getElementById("mon_dis").innerText;
  let re3 = document.getElementById("date_dis").innerText;

  let re = re2 + re3;
  localStorage.setItem("pick_up_date", JSON.stringify(re));
}

let months2 = document.getElementById("mon_dis");
let month_2ch = document.getElementById("mon_frb").innerText;
months2.innerText = month_2ch;
let dates2 = document.getElementById("date_dis");
...
let dis_month = document.getElementById("mon_dis").innerText;
let dis_date = document.getElementById("date_dis").innerText;

let res = dis_month + dis_date;
console.log("res:", res);
localStorage.setItem("pick_up_date", JSON.stringify(res));
...
function checkTime() {
  ...
  localStorage.setItem("pick_up_time", JSON.stringify(disp_time));
}
let time_par = document.getElementById("dt3_divin");
let time_dis = document.getElementById("timething1").value;
time_par.innerText = `Time: ${time_dis}`;
